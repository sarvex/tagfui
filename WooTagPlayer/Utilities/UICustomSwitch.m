...
//	[self setMinimumTrackImage:[[UIImage imageNamed:@"male"]stretchableImageWithLeftCapWidth:8.0 topCapHeight:0.0] forState:UIControlStateNormal];
//	[self setMaximumTrackImage:[[UIImage imageNamed:@"female"]stretchableImageWithLeftCapWidth:8.0 topCapHeight:0.0] forState:UIControlStateNormal];
