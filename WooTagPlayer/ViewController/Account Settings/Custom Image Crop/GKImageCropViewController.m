...
- (void)_setupUseButton{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
        ...
        [[self.useButton titleLabel] setFont:[UIFont systemFontOfSize:12]];
        [[self.useButton titleLabel] setShadowOffset:CGSizeMake(0, -1)];
...
//        [self _setupUseButton];
        ...
        UIBarButtonItem *cancel = [[UIBarButtonItem alloc] initWithTitle:@"Cancel" style:UIBarButtonItemStyleBordered target:self action:@selector(_actionCancel)];
...
//        UIBarButtonItem *lbl = [[UIBarButtonItem alloc] initWithCustomView:info];
        UIBarButtonItem *lbl = [[UIBarButtonItem alloc] initWithTitle:@"Move and Scale" style:UIBarButtonItemStylePlain target:nil action:nil];
//        UIBarButtonItem *use = [[UIBarButtonItem alloc] initWithCustomView:self.useButton];
        UIBarButtonItem *use = [[UIBarButtonItem alloc] initWithTitle:@"Choose" style:UIBarButtonItemStyleDone target:self action:@selector(_actionUse)];
